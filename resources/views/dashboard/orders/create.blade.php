                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">
                                    ...
                                    {{trans('admin.orders')}} </a>
                            </li>
                            <li class="breadcrumb-item active">{{trans('admin.create_order')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{trans('admin.create_order')}} </h4>
                                ...
                                <div class="card-body">
                                    <form class="form" action="{{route('orders.store')}}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ old('code') }}" type="text" class="form-control"
                                        ...
                                        <div class="mb-3">
                                            <label for="customer_id"> @lang('admin.customers')
                                            </label>
                                        ...
                                        <div class="mb-3">
                                            <div class="col form-group">
                                                <label>@lang('admin.description')<span

                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">
                                    ...
                                    {{trans('admin.customers')}} </a>
                            </li>
                            <li class="breadcrumb-item active">{{trans('admin.create_customer')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> {{trans('admin.create_customer')}} </h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <form class="form" action="{{route('customers.store')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input value="{{ old('whatsapp') }}" type="text" class="form-control" name="whatsapp" placeholder="{{trans('admin.whatsapp')}}">

    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title"> {{trans('admin.units')}} </h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}"> {{trans('admin.home')}} </a>
                            </li>
                            <li class="breadcrumb-item"> {{trans('admin.units')}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> {{trans('admin.units')}} </h4>
                                  ...
                                  <table class="table display nowrap table-striped table-bordered w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $value->name }}</td>
                                                <td>
                                                    @include('dashboard.components.table-control', ['permission' => 'units',
